...
import ru.mulledwine.shifts.extensions.getJobGenitive
import ru.mulledwine.shifts.ui.base.BaseFragment
import ru.mulledwine.shifts.ui.dialogs.JobDialog
import ru.mulledwine.shifts.viewmodels.JobsViewModel
...
class JobsFragment : BaseFragment<JobsViewModel>() {
    ...
    private fun navigateToStatistics() {
        ...
        viewModel.navigateToStatistics(selected.first().id)
    }
